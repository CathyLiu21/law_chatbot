...
def main():
    # Streamlit app
    st.set_page_config(page_title="ERISA Litigation and SummitGuard Client Assistant", page_icon="🦙", layout="centered", initial_sidebar_state="auto", menu_items=None)
    st.title('ERISA Litigation and SummitGuard Client Assistant')
    ...
    if openai_key:
        ...
        if prompt:
            if prompt.lower() == 'exit':
                st.write("Thank you for using the ERISA Litigation and SummitGuard Client Assistant. Goodbye!")
            else:
